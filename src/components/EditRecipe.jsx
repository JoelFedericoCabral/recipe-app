...
function EditRecipe() {
  ...
  // useEffect para cargar los datos de la receta en el formulario cuando el componente se monta
  useEffect(() => {
    const recipe = recipes.find((r) => r.id === id); // Buscar la receta por su ID
    if (recipe) {
      // Si se encuentra la receta, se cargan los datos en los estados correspondientes
      setName(recipe.name);
      setDescription(recipe.description);
      setIngredients(recipe.ingredients || "");
      setOriginalId(id); // Establecer el ID original en el contexto
    }
